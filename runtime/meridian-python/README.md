...
Python package or domain runtime dependency. The initial distribution version is
1.0.0 and supports the typed platform Meridian capability 1.1.0.

The profile fixes Python 3.12.11 / cp312 / Linux amd64 and the platform-selected
`postgresql-postgis-local-single-primary` profile. It contains the public Meridian
Core, Semantics, Query, Evidence and PostgreSQL wheels at 1.0.0, with every
...
limited to structured and evidence resources.
